    ...
    <div class="card">
        <div class="card-header">
            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                <a href="<?= base_url('admin/penmohon'); ?>" type="button" class="btn btn-primary">Baru</a>
            ...
            <input type="hidden" name="type" value="pending">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <a href="<?= base_url('admin/penmohon'); ?>" type="button" class="btn btn-primary btn-sm" style="margin-left:5px;">Reset</a>
                    </div>
                </div>
            </form>
        </div>
...
$('document').ready(function(){
    ...
    $('#PermohonanForm').submit(function(e){
        ...
        var confirmed = confirm("Lanjutkan Proses Penempatan Sesuai Data Yang Anda Cheklist ?");
