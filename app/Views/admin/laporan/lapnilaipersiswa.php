...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0">Export Nilai Per Siswa</h1>
        </div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item">Export Nilai Per Siswa</li>
        </ol>
        </div>
    </div>
    </div>
...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-header bg-gray-light">
            ...
            <form action="<?= base_url('admin/nilaipersiswa'); ?>" method="get">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <a href="<?= base_url('admin/nilaipersiswa'); ?>" type="button" class="btn btn-primary btn-sm" style="margin-left:5px;">Reset</a>
                    </div>
                </div>
            </form>
            ...
            <table class="table table-bordered table-hover" id="DataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a target="__BLANK" data-toggle="tooltip" data-placement="top" title="Cetak Nilai" href="<?= base_url('export/export_nilaipersiswa/'.$x->id_siswa.'/'.$x->id_jurusan); ?>" type="button" class="btn btn-primary btn-sm">Cetak Nilai</a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
